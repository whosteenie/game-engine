...
namespace
{
    nlohmann::json MakeSemantic()
    {
        return {
            ...
            {"scene", {{"project_path", "DEMO-SCENE.gameproject"}, {"project_sha256", "a"}, {"asset_manifest_sha256", "b"}}},
            ...
            {"diagnostics", {{"frame_trace", true}, {"gpu_events", true}, {"s0p2_token_trace", true}, {"s0p3_history_trace", true}, {"s0p4_scopes", true}}},
