...
namespace
{
    const std::vector<SettingRegistry::Descriptor> kDescriptors = {
        ...
        {"pt_mirror_chain_psr", "PT mirror-chain PSR", "path tracing primary surface replacement deterministic delta mirror chain", "Renderer Tuning", "Ray tracing", SettingRegistry::ControlType::Checkbox, SettingRegistry::PersistenceScope::SceneProject, SettingRegistry::UndoPolicy::Undoable, false},
        {"pt_rr_temporal_validity", "PT RR temporal validity", "path tracing ray reconstruction history rejection motion disocclusion ghosting", "Renderer Tuning", "Ray tracing", SettingRegistry::ControlType::Checkbox, SettingRegistry::PersistenceScope::SceneProject, SettingRegistry::UndoPolicy::Undoable, false},
